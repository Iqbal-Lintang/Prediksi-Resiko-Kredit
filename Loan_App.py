...
st.set_page_config(
    ...
    page_icon="https://drive.google.com/uc?export=view&id=1danCeVNbhEn7PsfR2koe2z6dXkzhcyjR",
    layout="wide"
)

# Construct the raw URL
logo_url = f"https://drive.google.com/uc?export=view&id=1danCeVNbhEn7PsfR2koe2z6dXkzhcyjR"
